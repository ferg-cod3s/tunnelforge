...
final class ServerManagerTests {
    ...
    func serverLifecycle() async throws {
        ...
        if !manager.isRunning {
            ...
            if let error = manager.lastError as? ServerManagerError {
    ...
    func startingAlreadyRunningServer() async throws {
        ...
        if let error1 = firstError as? ServerManagerError,
           let error2 = manager.lastError as? ServerManagerError
        {
