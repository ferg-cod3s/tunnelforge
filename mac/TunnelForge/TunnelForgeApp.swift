...
/// Main entry point for the TunnelForge macOS application.
///
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        // Kill other TunnelForge instances FIRST, before any other initialization
        ...
        guard let app else {
            fatalError("TunnelForgeApp instance not connected to AppDelegate")
        }
    ...
    private func handleSingleInstanceCheck() {
        ...
        if runningApps.count > 1 {
            ...
            Task { @MainActor in
                let alert = NSAlert()
                alert.messageText = "TunnelForge is already running"
                alert
                    .informativeText = "Another instance of TunnelForge is already running. This instance will now quit."
    ...
    /// Shows the Settings window when another TunnelForge instance asks us to.
    @objc
