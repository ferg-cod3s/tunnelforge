...
test.describe('TunnelForge Mac App Integration', () => {
  ...
  test('should display TunnelForge branding', async ({ page }) => {
    ...
    const brandingElements = page
      .locator('text=TunnelForge')
      .or(page.locator('[data-testid*="tunnelforge"]'));
  ...
  test('should show session list', async ({ page }) => {
    ...
    const createButton = page
      ...
      .or(page.locator('[data-testid="create-session"]'));
  ...
  test('should open terminal view when clicking on session', async ({ page }) => {
    ...
    const terminal = page
      .locator('vibe-terminal')
      .or(page.locator('vibe-terminal-binary'))
  ...
  test('should show proper error handling for offline servers', async ({ page }) => {
    ...
    await expect(
      page.locator('text=connection').or(page.locator('text=server').or(page.locator('text=error')))
